...
namespace Service
{
    public class CampaignService : ICampaignService
    {
        ...
        public async Task<CampaignDTO> GetBrandCampaignByCampaignId(Guid campaignId)
        {
        ...
        public async Task<List<string>> UploadCampaignImages(List<Guid> imageIds, List<IFormFile> contentFiles, UserDTO user, string folder)
        {
