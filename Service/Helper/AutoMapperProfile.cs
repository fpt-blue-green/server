...
namespace Service
{
    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<CampaignMeetingRoom, CampaignMeetingRoomDTO>()
                   .ForMember(dest => dest.Participants, opt =>
                       opt.MapFrom(src => string.IsNullOrEmpty(src.Participants)
                           ? new List<string>()
                           : src.Participants.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries).ToList()));
